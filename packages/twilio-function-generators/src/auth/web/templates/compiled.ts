...
export const authServiceCallback:TemplateDelegate = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!DOCTYPE html>\n<html>\n    <head>\n        <meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />\n        <link rel=\"icon\" type=\"image/x-icon\" href=\"favicon.ico\" />\n        <title>Login Callback</title>\n    </head>\n    <body>\n        <div id=\"main\">\n            <p class=\"message\">\n                "
    + alias4(((helper = (helper = lookupProperty(helpers,"twilioRequestSid") || (depth0 != null ? lookupProperty(depth0,"twilioRequestSid") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"twilioRequestSid","hash":{},"data":data,"loc":{"start":{"line":11,"column":16},"end":{"line":11,"column":36}}}) : helper)))
    + " - "
    + alias4(((helper = (helper = lookupProperty(helpers,"message") || (depth0 != null ? lookupProperty(depth0,"message") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"message","hash":{},"data":data,"loc":{"start":{"line":11,"column":39},"end":{"line":11,"column":50}}}) : helper)))
...
export const loginRedirectSuccess:TemplateDelegate = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!DOCTYPE html>\n<html>\n    <head>\n        <meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />\n        <link rel=\"icon\" type=\"image/x-icon\" href=\"favicon.ico\" />\n        <title>Login Redirect</title>\n    </head>\n    <body>\n        <div id=\"main\">\n            <p class=\"message\">\n                "
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"navLinkUrl") || (depth0 != null ? lookupProperty(depth0,"navLinkUrl") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"navLinkUrl","hash":{},"data":data,"loc":{"start":{"line":18,"column":42},"end":{"line":18,"column":56}}}) : helper)))
